...
function fixedfooter() {
    ...
    function template() {
        return [
            ...
            '.footer-wrap {padding-bottom: 10px; height:50px;}',
            ...
            '<nav class="navbar navbar-default navbar-fixed-bottom" style="position:fixed;">',
                '<div class="fixed-footer-bottom" style="margin-left:auto; margin-right:auto; text-align:center;">',
                    '<div class="footer-wrap" style="margin-left:auto; margin-right:auto;">',
                        '<div class="col-12">',
                            'If you are experiencing any issues please contact us at information@evo-creative.com.',
                            '</br>',
                            '&copy; {{year}} Evolution <i>creative solutions</i>. All Rights Reserved.',
                            '</br>',
                            'For Evolution <i>creative solutions</i> W9 Information: <a href="http://evo-creative.com/wp-content/uploads/2022/02/EVO-W9.pdf" target="_blank">DOWNLOAD HERE</a>',
                        '</div>',    
                    '</div>',
                '</div>',
            '</nav>'
