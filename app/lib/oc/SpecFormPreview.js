        ...
        return [
            ...
            '<div class="text-center">',
                '<span class="btn-group">',
                    '<button class="btn btn-default btn-sfp" ng-click="previewOnly(variant,true,varianterrors)"  style="background-color:#BF322E; color:#fff; font-weight:bold; text-transform:uppercase;">',
