four51.app.controller('KitCtrl', ['$scope', '$location', '$routeParams', 'Kit', 'ProductDisplayService', 'Order', 'User', 'Product', function($scope, $location, $routeParams, Kit, ProductDisplayService, Order, User, Product) {
